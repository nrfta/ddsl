...
var positiveTests = []posTestSpec{
	...
	posTestSpec{"seed schema foo_schema,bar_schema without foo_seed,bar_seed", "seed","schema", "without",[]string{"foo_schema","bar_schema"}, []string{"foo_seed","bar_seed"}},
	...
	posTestSpec{"seed table foo_schema.foo_table,bar_schema.bar_table with foo_seed,bar_seed", "seed","table", "with",[]string{"foo_schema.foo_table","bar_schema.bar_table"},[]string{"foo_seed","bar_seed"}},
